...
import { GreenCup_3d } from "./GreenCup_3d";

gsap.registerPlugin(ScrollTrigger);
gsap.ticker.lagSmoothing(0);

export default function GreenCup() {
  ...
  useEffect(() => {
    ...
    const waitForRef = () => {
      if (
        ...
        const container = document.getElementById("green-cup-container");
  ...
  return (
    ...
    >
      ...
      <GreenCup_3d ref={paperCupRef} scale={10} />
