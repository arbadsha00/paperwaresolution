...
import { Cup1_3d } from "./Cup1_3d";

gsap.registerPlugin(ScrollTrigger);
gsap.ticker.lagSmoothing(0);

export default function Cup_1() {
  ...
  useEffect(() => {
    ...
    const waitForRef = () => {
      if (
        ...
        const container = document.getElementById("featured-cup-1");
  ...
  return (
    ...
    >
      ...
      <Cup1_3d ref={paperCupRef} scale={10} />
